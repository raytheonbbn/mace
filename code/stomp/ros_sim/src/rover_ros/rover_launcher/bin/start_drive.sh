...
export PYTHONPATH="$PYTHONPATH:$ROVER_HOME/rover/src/rover_ros/rover_motor_driver/src"
export PYTHONPATH="$PYTHONPATH:$ROVER_HOME/rover/src/rover_ros/rover_motor_driver/src/roboclaw_driver"

roslaunch rover_launcher drive.launch
