...
public class SelectionHighlightController extends HighlightController implements MessageListener {
	...
	private static final Logger logger = Logger.getLogger(SelectionHighlightController.class.getName());

    protected CcastScreenSelector screenSelector;
    protected List<Highlightable> lastBoxHighlightObjects = new ArrayList<Highlightable>();

    public SelectionHighlightController(WorldWindow wwd, CcastScreenSelector screenSelector)
    {
	...
	public void onMessage(Message msg)
    {
        try
        {
            ...
            if (msg.getName().equals(CcastScreenSelector.SELECTION_STARTED)
                || msg.getName().equals(CcastScreenSelector.SELECTION_CHANGED))
            {
