...
openssl x509 -req -in certs/server.csr -days 10000 -CA ca_certificates/ca.crt -CAkey ca_certificates/ca.key -out certs/server.crt -extfile openssl.cnf -extensions v3_req 
