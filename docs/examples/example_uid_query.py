...
def read_uid_query_response_cb(client, userdata, message):
    """
...
def main():
    ...
    client.subscribe('agent/payload/query/uid')

    # Set the callback function
    client.message_callback_add('agent/payload/query/uid', read_uid_query_response_cb)

    # Start the client
    client.loop_start()

    # Publish the query
    client.publish('payload/agent/query/uid', '')
